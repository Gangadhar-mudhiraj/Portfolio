...
const Skill = ({ heading, content, icon }) => { // Added 'icon' to props
    ...
    return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out
                    flex flex-col items-center text-center">
            <span className="mb-4">
                {/* Use iconSrc for the image source */}
                <img src={iconSrc} alt={`${heading} Icon`} className="w-16 h-16 object-contain" />
            </span>
            <h1 className="text-xl md:text-2xl font-semibold text-blue-300 mb-2">
                {heading}
            </h1>
